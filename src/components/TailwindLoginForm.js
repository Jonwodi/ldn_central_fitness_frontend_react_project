      ...
      <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-[#212121]">
            ...
            <a
              href="/join"
              className="font-medium text-white hover:text-[#212121]">
          ...
          <div className="bg-[#212121] py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" action="#" method="POST">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-[#e65100] focus:ring-[#e65100] border-[#e65100] rounded"
                  />
                  <label
                    htmlFor="remember-me"
                ...
                <div className="text-sm">
                  <a
                    href="#"
                    className="font-medium text-[#e65100] hover:text-[#1de9b6]">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#e65100] hover:text-[#212121] hover:bg-[#1de9b6] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white">
                  Sign in
                </button>
              </div>
            </form>
